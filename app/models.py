...
class AutomationRule(Base):
    ...
    scheduler after each successful CAS claim (see run_scheduled_automations in
    app/services/automations.py); committed before condition evaluation so the
    claim persists even when conditions evaluate false.
