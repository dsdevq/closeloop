...
- Name: smoke.spec.ts >> Import >> import UI trigger [UI gap — no import button in current SPA]
- Location: e2e/smoke.spec.ts:599:3
...
Locator: getByRole('button', { name: /import/i }).or(getByRole('link', { name: /import/i }))
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /import/i }).or(getByRole('link', { name: /import/i }))
