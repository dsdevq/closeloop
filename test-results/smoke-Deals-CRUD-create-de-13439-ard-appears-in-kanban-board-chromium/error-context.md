...
- Name: smoke.spec.ts >> Deals CRUD >> create deal via New Deal modal — card appears in kanban board
- Location: e2e/smoke.spec.ts:258:3
...
Locator: getByText('Smoke Kanban Deal pyfl6')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Smoke Kanban Deal pyfl6')
